<section>
  ...
  <form method="post" action="edit.php?id=<?= $_GET["id"] ?>">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" name="iso_code" id="iso_code" placeholder="Ingrese..." value="<?= isset($_POST["iso_code"]) ? $_POST["iso_code"] : $values->iso_code ?>" maxlength="4" max="4">
    </div>
